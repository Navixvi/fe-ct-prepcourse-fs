...
function invocarMetodo(objeto, metodo) {
   ...
   // Tu código:
   var tieneParametro = objeto.hasOwnProperty(metodo);
   if(tieneParametro === true){
      objeto[metodo]();
   }
}
...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
   var tieneObjeto = objetoMisterioso.hasOwnProperty('numeroMisterioso')
   if(tieneObjeto ===true){
...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   var verificacion = typeof objetoUsuario.email !== 'undefined';
   return verificacion;
}
